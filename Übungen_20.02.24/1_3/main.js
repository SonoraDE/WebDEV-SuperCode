function getBrowserInfo() {
  ...
  console.log("Window Auflösung:", window.screen.width + "x" + window.screen.height);
  console.log("Innenhöhe und -breite des Dokuments:", document.documentElement.clientWidth + "x" + document.documentElement.clientHeight);
